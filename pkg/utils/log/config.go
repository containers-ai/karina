/*
Copyright 2019 The FederatorsAI Authors.
...
// Karina components.
//
// Karina's logging subsystem is built on top of the [Zap](https://godoc.org/go.uber.org/zap) package.
...
// Configure initializes Karina's logging subsystem.
//
